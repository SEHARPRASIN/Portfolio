...
const Language = () => {
  return (
    <section id='languages' data-aos='fade-up' data-aos-delays='250' className='w-full py-16 px-4 sm:px-8 bg-white'>
        <div className='max-w-6xl mx-auto relative'>
            <div className='text-center mb-12'>
                ...
                <p className='text-gray-600 max-w-lg mx-auto'>
                    I hereby declare my proficiency in the following languages
                </p>
            </div>
